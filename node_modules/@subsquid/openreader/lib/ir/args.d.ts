...
export type BinaryOp = 'eq' | 'not_eq' | 'gt' | 'gte' | 'lt' | 'lte' | 'contains' | 'not_contains' | 'containsInsensitive' | 'not_containsInsensitive' | 'startsWith' | 'not_startsWith' | 'startsWithInsensitive' | 'not_startsWithInsensitive' | 'endsWith' | 'not_endsWith' | 'endsWithInsensitive' | 'not_endsWithInsensitive' | 'containsAll' | 'containsAny' | 'containsNone' | 'jsonContains' | 'jsonHasKey';
