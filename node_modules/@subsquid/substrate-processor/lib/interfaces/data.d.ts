...
import { BlockRequiredFields, CallRequiredFields, EventRequiredFields, ExtrinsicRequiredFields, Simplify } from './data-partial';
...
export type BlockHeader<F extends FieldSelection = {}> = Simplify<{
    id: string;
} & Pick<base.BlockHeader, BlockRequiredFields> & Select<base.BlockHeader, GetFields<F, 'block'>> & {
    _runtime: Runtime;
...
export type Extrinsic<F extends FieldSelection = {}> = Simplify<{
    id: string;
} & Pick<FullExtrinsic, ExtrinsicRequiredFields> & Select<FullExtrinsic, GetFields<F, 'extrinsic'>> & {
    block: BlockHeader<F>;
    call?: Call<F>;
    getCall(): Call<F>;
    subcalls: Call<F>[];
...
export type Call<F extends FieldSelection = {}> = Simplify<{
    id: string;
} & Pick<FullCall, CallRequiredFields> & Select<FullCall, GetFields<F, 'call'>> & {
    block: BlockHeader<F>;
...
export type Event<F extends FieldSelection = {}> = Simplify<{
    id: string;
} & Pick<BaseEvent, EventRequiredFields> & Select<BaseEvent, GetFields<F, 'event'>> & {
    block: BlockHeader<F>;
    call?: Call<F>;
    getCall(): Call<F>;
    extrinsic?: Extrinsic<F>;
