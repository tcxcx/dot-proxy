...
export type Type = PrimitiveType | CompactType | SequenceType | BitSequenceType | ArrayType | HexBytesType | HexBytesArrayType | TupleType | OptionType | CompositeType | VariantType | DoNotConstructType;
/**
