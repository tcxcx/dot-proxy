...
exports.sha = exports.DCGHasher = void 0;
...
class DCGHasher {
    ...
    getHash(ni) {
        (0, assert_1.default)(0 <= ni && ni < this.graph.length);
    ...
    visit(ni) {
        let parent = (0, util_internal_1.assertNotNull)(this.parentNode);
...
exports.sha = sha;
//# sourceMappingURL=dcg-hasher.js.map