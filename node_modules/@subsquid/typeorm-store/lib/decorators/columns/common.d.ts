 ...
 */
export type PrimaryGeneratedColumnType = 'int' | 'int2' | 'int4' | 'int8' | 'integer' | 'smallint' | 'bigint' | 'decimal' | 'numeric';
/**
 ...
 */
export type WithPrecisionColumnType = 'float' | 'decimal' | 'numeric' | 'real' | 'double precision' | 'time' | 'time with time zone' | 'time without time zone' | 'timestamp' | 'timestamp without time zone' | 'timestamp with time zone';
/**
 ...
 */
export type SimpleColumnType = 'int2' | 'integer' | 'int4' | 'int8' | 'float' | 'float4' | 'float8' | 'money' | 'boolean' | 'bool' | 'text' | 'citext' | 'hstore' | 'bytea' | 'timetz' | 'timestamptz' | 'date' | 'interval' | 'point' | 'line' | 'lseg' | 'box' | 'circle' | 'path' | 'polygon' | 'geography' | 'geometry' | 'int4range' | 'int8range' | 'numrange' | 'tsrange' | 'tstzrange' | 'daterange' | 'enum' | 'cidr' | 'inet' | 'macaddr' | 'bit' | 'bit varying' | 'varbit' | 'tsvector' | 'tsquery' | 'uuid' | 'xml' | 'json' | 'jsonb' | 'cube' | 'ltree';
/**
