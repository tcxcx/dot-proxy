...
exports.FileOrUrl = exports.Url = exports.positiveReal = exports.positiveInt = exports.nat = void 0;
...
function positiveReal(s) {
    let x = Number(s);
    if (isNaN(x) || x <= 0)
        throw new commander_1.InvalidArgumentError('Not a positive real number');
    return x;
}
exports.positiveReal = positiveReal;
